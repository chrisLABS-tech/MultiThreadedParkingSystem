...
/**
 *  @author chrisjackson
 *  File: FeeStrategyWeekday.java
 */

public class FeeStrategyWeekday extends ParkingFeeCalculator {
    private BigDecimal parkingFee;

    public FeeStrategyWeekday(FeeStrategy feeStrategy) {
        super(feeStrategy);
    }
    ...
    public String generateFeeDescription() {
        return feeStrategy.generateFeeDescription() + ", Weekday";
    }
}
